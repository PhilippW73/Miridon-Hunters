INSERT INTO actions (name, actionType, category, weapon, function, strength_cost, speed_cost, subtlety_mod)
VALUES
...
( "Charge", "Movement", "basics", "melee", "Turn up to 60°
Run Forward 10 ft
...
( "Turn", "Movement", "movement", "", "Turn to face any direction", 0, 0, null ),
...
( "Recover Ghost HP with Strength", "Spell Casting Modifier", "spells", "", "Recover 1 [Spell Ghost HP]
using Strength Points", 1, 0, null ),
( "Recover Ghost HP with Speed", "Spell Casting Modifier", "spells", "", "Recover 1 [Spell Ghost HP]
using Speed Points", 0, 1, null ),
( "Melee Attack", "Offensive", "basics", "melee", "Attack with melee weapon
See Weapon for damage/to hit", 2, 1, -5 ),
( "Melee Combo Attack", "Offensive", "basics", "melee", "Act as [Melee Attack]
Must follow another [Melee Attack]
or [Melee Combo Attack]", 1, 2, -5 ),
( "Gun Attack", "Offensive", "basics", "ranged", "See Weapon for damage/to hit", 0, 2, 5 ),
( "Aimed Attack", "Offensive", "basics", "ranged", "Attack with gun
Act as [Gun Attack]
+3 to hit", 0, 3, 5 ),
( "Reload", "Offensive", "skills", "ranged", "Reloads a Gun to Full Ammo", 1, 0, null ),
