...
function meleeAttack(who){
    if(who.curStats.strength_point < 2 || who.curStats.speed_point < 1) {
        $("#comments p").append(who.fullStats.character_name+" did not have enough energy to attack. They attempt to gather strength. ");
        restoreStrength(who);
    } else {
...
function meleeCombo(who){
    if(who.curStats.strength_point < 1 || who.curStats.speed_point < 2) {
        $("#comments p").append(who.fullStats.character_name+" did not have enough energy to attack. They attempt to gather strength. ");
        restoreStrength(who);
    } else {
...
//}
function charge(who) {
    if(who.curStats.speed_point > 0 ) {
        who.curStats.speed_point--;
        $("#comments p").append(who.fullStats.character_name + " charged. ");
    } else {
        $("#comments p").append(who.fullStats.character_name+" did not have enough strength to charge. They attempt to gather speed. ");
        restoreSpeed(who);
    }
}

function block(who) {
    if(who.curStats.strength_point > 1 ) {
        who.curStats.strength_point = who.curStats.strength_point - 2;
        $("#comments p").append(who.fullStats.character_name + " blocked. ");
    } else {
        $("#comments p").append(who.fullStats.character_name+" did not have enough strength to block. ");
    }
}
...
function dodge(who) {
    if(who.curStats.speed_point > 0 ) {
        who.curStats.speed_point--;
        $("#comments p").append(who.fullStats.character_name + " attempted to dodge. ");
    } else {
        $("#comments p").append(who.fullStats.character_name+" did not have enough speed to dodge. ");
    }
}